...
describe('EthAddress component sanity', function () {
  ...
  it('matches default snapshot', function () {
    var component = render( /*#__PURE__*/React.createElement(EthAddress, {
      address: testAddress
    }));
  ...
  it('matches themed snapshot', function () {
    var component = render( /*#__PURE__*/React.createElement(ThemeProvider, {
      theme: theme
    }, /*#__PURE__*/React.createElement(EthAddress, {
      address: testAddress
    })));
    expect(component).toMatchSnapshot();
  });
...
describe('EthAddress component rendering', function () {
  var component = mount( /*#__PURE__*/React.createElement(EthAddress, {
